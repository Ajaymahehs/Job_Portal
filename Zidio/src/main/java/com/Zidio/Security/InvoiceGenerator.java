...
public class InvoiceGenerator {
    ...
    public static ByteArrayInputStream generateInvoice(PaidSubscription sub) {
        ...
        try {
            ...
            table.addCell(new Paragraph("Recruiter Email", labelFont));
            table.addCell(new Paragraph(String.valueOf(sub.getRecruiterEmail()), valueFont));

            table.addCell(new Paragraph("Employee Email", labelFont));
            table.addCell(new Paragraph(String.valueOf(sub.getEmployeeEmail()), valueFont));
